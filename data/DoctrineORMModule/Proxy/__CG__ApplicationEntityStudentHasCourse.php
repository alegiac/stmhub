 ...
 */
class StudentHasCourse extends \Application\Entity\StudentHasCourse implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\StudentHasCourse' . "\0" . 'id', '' . "\0" . 'Application\\Entity\\StudentHasCourse' . "\0" . 'insertDate', '' . "\0" . 'Application\\Entity\\StudentHasCourse' . "\0" . 'activationstatus', '' . "\0" . 'Application\\Entity\\StudentHasCourse' . "\0" . 'course', '' . "\0" . 'Application\\Entity\\StudentHasCourse' . "\0" . 'student');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (StudentHasCourse $proxy) {
