                ...
                <div class="card">
                    ...
                    <div class="card-body card-padding">
                        <div class="row">
                            <center>
                                <h4>Attenzione!</h4><br>
                                I tuoi dati risultano già associati al corso <strong>{$coursename}</strong> sulla piattaforma TRAINTOACTION.<br>
                                Controlla le tue email per partecipare alle sessioni.<br><br>
                                Buon lavoro!
                            </center>
                            <br>
                            <br>
